...
@Service
public class LendingReturnOrderService {
    ...
    public LendingReturnOrderService(LendingReturnOrderRepository lendingReturnOrderRepository, LendingReturnOrderMapper lendingReturnOrderMapper,
